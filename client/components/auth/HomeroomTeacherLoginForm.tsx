...
export default function HomeroomTeacherLoginForm() {
    ...
    const { login, settings } = useAuth(); // Ambil 'settings' dari useAuth
            ...
            <div className="relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
                ...
                <div className="relative hidden md:block">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-center w-full px-4">
                        ...
                        {/* ================================================================== */}
                        {/* --- LOGIKA BARU UNTUK LOGO DAN NAMA DITEMPATKAN DI SINI --- */}
                        {/* ================================================================== */}
                        {settings?.loginLogo ? (
                            <Image src={settings.loginLogo} alt="Logo" width={200} height={50} className="mx-auto mb-4"/>
                        ) : settings?.schoolName ? (
                            <h1 className="text-3xl font-bold mb-4">{settings.schoolName}</h1>
                        ) : (
                            <Image src="/images/lg_spada_satap.png" alt="Logo Default" width={200} height={50} className="mx-auto mb-4"/>
                        )}
